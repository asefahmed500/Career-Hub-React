    ...
    return (
        <div className="card card-compact  bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <div className="mt-4 flex space-x-40">
                    <h2 className="flex mr-2"><GoLocation className="text-2xl text-black">{location}</GoLocation></h2>
                    <h2 className="flex mr-2"><HiCurrencyDollar className="text-2xl text-black">{salary}</HiCurrencyDollar></h2>
                </div>
